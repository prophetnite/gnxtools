...
def start_xml(script_start_time):
	...
	nmaprun_attribs =  {'scanner' : sys.argv[0], 'args' : scriptargs, 'start' : str(script_start_time), 'version' : '1.0', 'xmloutputversion' : '1.04'}
	...
	for current_file in file_list:
		try: 
			...
			for current_host in current_nmap_file_blob.findall('host'):
				...
				total_seconds = (total_seconds + calc_seconds(current_host.attrib['starttime'], current_host.attrib['endtime']))
...
def output_results(nmap_file_preamble, nmaprun, merge_job_output):
	...
	sys.stderr.write( "\n\nMerged " + str(total_hosts) + " hosts from " + str(files_processed) + " xml files. " + str(len(bad_file_list)) + " invalid files skipped.")	
